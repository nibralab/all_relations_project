...
class RoboFile extends \Robo\Tasks
{
	...
	public function createTestingSite($use_htaccess = false)
	{
		...
		if (!file_exists('dist/pkg-all_relations_project-current.zip'))
		{
			$this->build(true);
		}

		$this->_copy('dist/pkg-all_relations_project-current.zip', $this->cmsPath . "/pkg-all_relations_project-current.zip");
	...
	/**
	 * Update Version __DEPLOY_VERSION__ in All Relations Project. (Set the version up in the jorobo.ini)
	 *
	 * @return  void
	 */
