# {{ project.name | title }} for Joomla! Travis:

Travis: [![Travis Build Status](https://travis-ci.org/{{ project.repository }}.svg?branch=master)](https://travis-ci.org/{{ project.repository }}) 

Drone: [![Drone Build Status](http://213.160.72.75/api/badges/{{ project.repository }}/status.svg)](http://213.160.72.75/{{ project.repository }})

This repo is meant to hold the com_{{ project.name | file }} component and related code.
...
Install the last release of [com_{{ project.name | file }}](https://github.com/{{ project.repository }}/releases/latest) into your Joomla.
Install the last release of [com_patchtester](https://github.com/joomla-extensions/patchtester/releases/latest) into your Joomla.
...
```
/var/www/html$ git clone git@github.com:{{ project.repository }}.git
Clone nach 'weblinks' ...
...
If you get an error you can try git clone https://github.com:{{ project.repository }}.git instead of git clone git@github.com:{{ project.repository }}.git
...
or https://github.com/{{ project.repository }}/blob/master/composer.json
...
modules:
    ...
    config:
        ...
        AcceptanceHelper:
            repo_folder: '/home/travis/build/{{ project.repository }}/' # Path to the Extension repository. To be used by tests to install via Install from folder
